            ...
            @csrf
              ...
              <div class="card-body">
                ...
                <div class="input-group">
                  ...
                  <input  type="password" placeholder="Confirmar Contraseña..." class="form-control @error('password') is-invalid @enderror" name="password_confirmation" required autocomplete="current-password">
                </div>
                </div>
